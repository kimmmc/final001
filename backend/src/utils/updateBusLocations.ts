...
// Rwanda locations for bus positioning
...
export const updateBusLocations = async () => {
  try {
    ...
    for (const bus of buses) {
      // Skip buses that already have recent Rwanda locations
